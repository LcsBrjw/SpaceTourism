                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-destinations">
                                <a href="#endpoints-POSTapi-destinations">Get all destinations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-destinations--id-">
                                <a href="#endpoints-PUTapi-destinations--id-">Get all destinations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-destinations--id-">
                                <a href="#endpoints-DELETEapi-destinations--id-">Get all destinations</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-crews">
                                <a href="#endpoints-GETapi-crews">Get all crews</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-crews">
                                <a href="#endpoints-POSTapi-crews">Get all crews</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-crews--id-">
                                <a href="#endpoints-PUTapi-crews--id-">Get all crews</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-crews--id-">
                                <a href="#endpoints-DELETEapi-crews--id-">Get all crews</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-technologies">
                                <a href="#endpoints-POSTapi-technologies">Get all technologies</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-technologies--id-">
                                <a href="#endpoints-PUTapi-technologies--id-">Get all technologies</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-technologies--id-">
                                <a href="#endpoints-DELETEapi-technologies--id-">Get all technologies</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-destinations">Get all destinations</h2>

<p>
</p>

<p>This endpoint returns a list of all destinations in the system.</p>
...
<div class="bash-example">
    ...
    \"avgDist\": 11613.31890586,
    \"timeTravel\": 11613.31890586
}"
</code></pre></div>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>avgDist</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="avgDist"                data-endpoint="POSTapi-destinations"
...
<p>Example: <code>11613.31890586</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>timeTravel</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="timeTravel"                data-endpoint="POSTapi-destinations"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-destinations--id-">Get all destinations</h2>
...
<div class="bash-example">
    ...
    \"avgDist\": 11613.31890586,
    \"timeTravel\": 11613.31890586,
    \"imageUrl\": \"http:\\/\\/www.moore.com\\/dolor-dolores-minus-voluptatem-quisquam-quibusdam-sed-vel.html\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-destinations--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the destination. Example: <code>consequatur</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="avgDist"                data-endpoint="PUTapi-destinations--id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="timeTravel"                data-endpoint="PUTapi-destinations--id-"
               value="11613.31890586"
               data-component="body">
    <br>
<p>Example: <code>11613.31890586</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="imageUrl"                data-endpoint="PUTapi-destinations--id-"
...
<p>Must be a valid URL. Example: <code>http://www.moore.com/dolor-dolores-minus-voluptatem-quisquam-quibusdam-sed-vel.html</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-destinations--id-">Get all destinations</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-destinations--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the destination. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-crews">Get all crews</h2>

<p>
</p>

<p>This endpoint returns a list of all crews in the system.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-crews">Get all crews</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-crews"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<p>Must be a valid URL. Example: <code>http://reynolds.com/</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-crews--id-">Get all crews</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/crews/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"vmqeopfuudtdsufvyvddq\",
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-crews--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the crew. Example: <code>consequatur</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-crews--id-"
               value="Dolores dolorum amet iste laborum eius est dolor."
               data-component="body">
    <br>
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
...
<p>Must be a valid URL. Example: <code>http://reynolds.com/</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-crews--id-">Get all crews</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-crews--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the crew. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-technologies">Get all technologies</h2>

<p>
</p>

<p>This endpoint returns a list of all technologys in the system.</p>
...
<div class="bash-example">
    ...
    \"name\": \"vmqeopfuudtdsufvyvddq\",
    \"description\": \"Dolores dolorum amet iste laborum eius est dolor.\",
    \"imgMob\": \"http:\\/\\/reynolds.com\\/\",
    \"imgDesk\": \"http:\\/\\/schmeler.com\\/a-quo-sed-fugit-facilis-perferendis-dolores-molestias\"
}"
</code></pre></div>
...
<p>Example: <code>Dolores dolorum amet iste laborum eius est dolor.</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>imgMob</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="imgMob"                data-endpoint="POSTapi-technologies"
               value="http://reynolds.com/"
               data-component="body">
    <br>
<p>Must be a valid URL. Example: <code>http://reynolds.com/</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>imgDesk</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="imgDesk"                data-endpoint="POSTapi-technologies"
...
<p>Must be a valid URL. Example: <code>http://schmeler.com/a-quo-sed-fugit-facilis-perferendis-dolores-molestias</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-technologies--id-">Get all technologies</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/technologies/consequatur" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"vmqeopfuudtdsufvyvddq\",
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-technologies--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the technology. Example: <code>consequatur</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="imgMob"                data-endpoint="PUTapi-technologies--id-"
               value="http://reynolds.com/"
               data-component="body">
    <br>
<p>Must be a valid URL. Example: <code>http://reynolds.com/</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="imgDesk"                data-endpoint="PUTapi-technologies--id-"
               value="http://schmeler.com/a-quo-sed-fugit-facilis-perferendis-dolores-molestias"
               data-component="body">
    <br>
<p>Must be a valid URL. Example: <code>http://schmeler.com/a-quo-sed-fugit-facilis-perferendis-dolores-molestias</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-technologies--id-">Get all technologies</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-technologies--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the technology. Example: <code>consequatur</code></p>
